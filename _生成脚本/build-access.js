...
const ENTRIES = [
  {
    ...
    color: "var(--w-teal)",
    desc: "19 个模拟器，覆盖四大滴定、电化学、光谱与质谱、色谱与分离、空间结构、数据与质量，以及课程实验的完整制备流程。每个模拟器同时呈现符号层曲线、宏观层装置与微观层粒子。",
    how: "无需登录。点左侧导航切换模拟器，拖动参数滑块，三层视图同步变化；课程实验可先跟教学模式走一遍规范操作，再到练习模式自己动手。",
  },
  {
    key: "teacher",
    kind: "教师端",
...
<div class="wrap">
  ...
  <div class="quick">
    ...
    <ol>
      ...
      <li>选<b>硫酸亚铁铵的制备</b>，看最后一项<b>「目视比色定级」</b>：五支比色管并排，左边三支是标准色阶，最右是样品。这是本工作台上唯一的<b>过程型</b>模拟器——还原课程实验四十的十二步完整操作链。切到<b>练习模式</b>点「运行实验」，初始条件是故意留了错的，产量会偏低；再逐项改正，看产量和试剂级别怎么回来。</li>
